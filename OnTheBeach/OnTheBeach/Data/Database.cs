...
namespace OnTheBeach.Data
{
    public static class Database
    {
        ...
        static Database()
        {
            Flights = JsonConvert.DeserializeObject<List<Flight>>(FlightData);
            Hotels = JsonConvert.DeserializeObject<List<Hotel>>(HotelData);
        }

        private const string FlightData = 
            @"[
                {
                ""id"": 1,
        ...
        private const string HotelData =
            @"[
                {
                ""id"": 1,
